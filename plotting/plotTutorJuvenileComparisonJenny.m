...
centMatch = loadFromManifest(rep.manifest,'centMatch'); %RY changed to use bestTutMatch
%bestTutMatch = loadFromManifest(rep.manifest, 'bestTutMatch');
%bestTutMatch=cell2mat(bestTutMatch)-'a'+1; %convert from letter to number labels (syll a, b, c -> 1, 2, 3); not sure why/how this works but it does. 
...
%tutorMatchToClust = bestTutMatch(isCluster);
