function [empMatrices, distMatrices, empDistrs] = DRcluster(DRsylls, featureTable, spectra, params, varargin)
...
% remove any syllables that are too short (RY commented out - this is already done when assembling DRsylls)
