% Script for segmenting syllables from .wav files. Modified from
% segmentAndCluster_auto.m to take entire .wav files & segment syllables.
% Meant to be automated rough pass at segmentation, just to get an idea of
% syllable types
%
